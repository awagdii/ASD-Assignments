...
public class Mission
{
	...
	public Scenario getResearchPlan() { return Associations.researchScenarioConsideredForAMission.rightToLeft(this); }
	...
	public String getReport(String indentation)
	{
		...
		Scenario researchPlanScenario = getResearchPlan();								// Using the Associations Framework
		if (researchPlanScenario != null)
			report.append(indentation + "Research Plan :" + researchPlanScenario.getReport(""));

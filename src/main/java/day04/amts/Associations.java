...
public class Associations {
    ...
    static public OneToMany<Scenario, Mission> researchScenarioConsideredForAMission = new OneToMany<>(" Is Considered For ", " Considers ", "Research Plan", "Mission");
    ...
    static public OneToMany<Scenario, Action> scenarioIsComposedOfConfirmedActions =
            new OneToMany<>( "Is Made Of","Was Confirmed During", "Actual Scenario", "Confirmed Action");
    ...
    static public String report() {
        ...
        str.append(researchScenarioConsideredForAMission);
        ...
        str.append(scenarioIsComposedOfConfirmedActions);

...
public class Domain {
    public void buildDynamicObjects() {
        ...
        for (SingleScenario singleScenario : singleScenarios) {
            Associations.researchScenarioConsideredForAMission.link(singleScenario, theMojaveSurvey);
        }
        singleScenarios[special].isRetainedFor(theMojaveSurvey);

        // This Scenario is retained for the first Mission
